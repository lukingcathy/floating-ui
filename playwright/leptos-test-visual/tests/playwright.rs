...
pub fn playwright() {
    ...
    let repository_dom_path = repository_path.join("../../dom");
    ...
    let visual_test_path = Path::new(env!("CARGO_MANIFEST_DIR")).join("playwright/leptos-test-visual");
